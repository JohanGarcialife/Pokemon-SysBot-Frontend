...
export interface LegendaryPreset {
  ...
  fullyLocked: boolean
  /** Force specific gender (M = Male, F = Female, N = Genderless) */
  gender?: 'M' | 'F' | 'N'
}
...
export const LEGENDARY_PRESETS: Record<string, LegendaryPreset> = {
  ...
  terapagos: {
    ...
    nature: 'timid',
    ability: 'tera-shift',
    moves: ['tera-starstorm', 'ancient-power', 'calm-mind', 'protect'],
    shinyAllowed: false,
  ...
  // ── Scarlet / Violet: Cuarteto Ruinoso ────────────────────────────────────
  // Pueden ser shiny via HOME events. El preset es para el encuentro estático normal.
  'wo-chien': {
    label: 'Wo-Chien — Captura en SV (Grasswither Shrine)',
    level: 60,
    nature: 'calm',
    ability: 'tablets-of-ruin',
    moves: ['ruination', 'giga-drain', 'leech-seed', 'knock-off'],
    shinyAllowed: true,
    forcedOrigin: 'Wild Encounter',
    forcedBall: 'Poké Ball',
    fullyLocked: true,
  ...
  'chien-pao': {
    label: 'Chien-Pao — Captura en SV (Icerend Shrine)',
    level: 60,
    nature: 'jolly',
    ability: 'sword-of-ruin',
    moves: ['ruination', 'ice-spinner', 'crunch', 'sucker-punch'],
    shinyAllowed: true,
    forcedOrigin: 'Wild Encounter',
    forcedBall: 'Poké Ball',
    fullyLocked: true,
  ...
  'ting-lu': {
    label: 'Ting-Lu — Captura en SV (Groundblight Shrine)',
    level: 60,
    nature: 'careful',
    ability: 'vessel-of-ruin',
    moves: ['ruination', 'earthquake', 'rest', 'bulk-up'],
    shinyAllowed: true,
    forcedOrigin: 'Wild Encounter',
    forcedBall: 'Poké Ball',
    fullyLocked: true,
  ...
  'chi-yu': {
    label: 'Chi-Yu — Captura en SV (Firescourge Shrine)',
    level: 60,
    nature: 'timid',
    ability: 'beads-of-ruin',
    moves: ['ruination', 'overheat', 'dark-pulse', 'nasty-plot'],
    shinyAllowed: true,
    forcedOrigin: 'Wild Encounter',
    forcedBall: 'Poké Ball',
    fullyLocked: true,
  ...
  'okidogi': {
    label: 'Okidogi — Kitakami (Macho)',
    level: 70,
    nature: 'adamant',
    ability: 'toxic-chain',
    moves: ['superpower', 'poison-jab', 'bulk-up', 'crunch'],
    shinyAllowed: false,
    forcedOrigin: 'Wild Encounter',
    forcedBall: 'Poké Ball',
    fullyLocked: true,
  ...
  'munkidori': {
    label: 'Munkidori — Kitakami (Macho)',
    level: 70,
    nature: 'modest',
    ability: 'toxic-chain',
    moves: ['psychic', 'sludge-wave', 'nasty-plot', 'shadow-ball'],
    shinyAllowed: false,
    forcedOrigin: 'Wild Encounter',
    forcedBall: 'Poké Ball',
    fullyLocked: true,
  ...
  'fezandipiti': {
    label: 'Fezandipiti — Kitakami (Macho)',
    level: 70,
    nature: 'jolly',
    ability: 'toxic-chain',
    moves: ['play-rough', 'poison-jab', 'roost', 'u-turn'],
    shinyAllowed: false,
    forcedOrigin: 'Wild Encounter',
    forcedBall: 'Poké Ball',
    fullyLocked: true,
  ...
  'ogerpon': {
    label: 'Ogerpon — Kitakami (Hembra)',
    level: 70,
    nature: 'lonely',
    ability: 'defiant',
    moves: ['ivy-cudgel', 'wood-hammer', 'play-rough', 'spiky-shield'],
    shinyAllowed: false,
    forcedOrigin: 'Wild Encounter',
    forcedBall: 'Poké Ball',
    fullyLocked: true,
  ...
  'pecharunt': {
    label: 'Pecharunt — Kitakami',
    level: 88,
    nature: 'timid',
    ability: 'poison-puppeteer',
    moves: ['malignant-chain', 'shadow-ball', 'nasty-plot', 'recover'],
    shinyAllowed: false,
    forcedOrigin: 'Wild Encounter',
    forcedBall: 'Poké Ball',
    fullyLocked: true,
  ...
  'koraidon': {
    label: 'Koraidon — Paldea',
    level: 72,
    nature: 'adamant',
    ability: 'orichalcum-pulse',
    moves: ['collision-course', 'flamethrower', 'close-combat', 'outrage'],
    shinyAllowed: true,
    forcedOrigin: 'Wild Encounter',
    forcedBall: 'Poké Ball',
    fullyLocked: true,
  ...
  'miraidon': {
    label: 'Miraidon — Paldea',
    level: 72,
    nature: 'modest',
    ability: 'hadron-engine',
    moves: ['electro-drift', 'power-gem', 'discharge', 'overheat'],
    shinyAllowed: true,
    forcedOrigin: 'Wild Encounter',
    forcedBall: 'Poké Ball',
    fullyLocked: true,
  ...
  'ursaluna-bloodmoon': {
    label: 'Ursaluna-Bloodmoon — Kitakami (Macho)',
    level: 70,
    nature: 'quiet',
    ability: 'minds-eye',
    moves: ['blood-moon', 'earth-power', 'moonlight', 'yawn'],
    shinyAllowed: true,
    forcedOrigin: 'Wild Encounter',
    forcedBall: 'Poké Ball',
    fullyLocked: true,
  ...
  // ── Legends: Z-A ────────────────────────────────────────────────────────────
  // Shiny versions are delivered as .pa9/.pk9 files directly to the bot by the backend.
  rayquaza: {
  ...
  genesect: {
    ...
    nature: 'hasty',
    ability: 'download',
    moves: ['techno-blast', 'x-scissor', 'iron-head', 'metal-claw'],
    shinyAllowed: true,    // shiny from the 2013 JP event (already in EVENT_MOVESETS)
    forcedOrigin: 'Wild Encounter',
    forcedBall: 'Poké Ball',
    fullyLocked: true,
  },
  // Hoopa is in the ZA DLC (Lumiose Hyperspace). Only Hoopa-Confined can be captured.
  hoopa: {
    label: 'Hoopa — Captura en Leyendas Z-A (DLC)',
    level: 50,
    nature: 'bold',
    ability: 'magician',
    moves: ['hyperspace-hole', 'psychic', 'shadow-ball', 'nasty-plot'],
    shinyAllowed: false,   // shiny-locked in ZA (in LZA_SHINY_LOCKED_POKEMON)
    forcedOrigin: 'Wild Encounter',
    forcedBall: 'Poké Ball',
    fullyLocked: true,
  },
